...
if (isset($_GET['Application_Letter'])) {
    ...
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['App_letter'];
    if (file_exists($filepath)) {
        ...
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['App_letter']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['App_letter']);
...
if (isset($_GET['MVS'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['MVS'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['MVS']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['MVS']);
...
if (isset($_GET['Aff_Lead'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['Aff_Lead'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Aff_Lead']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Aff_Lead']);
...
if (isset($_GET['Resolution'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['Resolution'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Resolution']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Resolution']);
...
if (isset($_GET['Permission'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['Letter_Permission'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Letter_Permission']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Letter_Permission']);
...
if (isset($_GET['Consent'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['Letter_content'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Letter_content']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Letter_content']);
...
if (isset($_GET['Lists'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['Lists'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Lists']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Lists']);
...
if (isset($_GET['ConsLaw'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['ConsLaw'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['ConsLaw']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['ConsLaw']);
...
if (isset($_GET['Logo'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = 'Org_Applications/'. $file['Logo'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Logo']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Logo']);
...
if (isset($_GET['Intent'])) {
    ...
    $file = mysqli_fetch_assoc($result);
    $filepath = '../O-StudentDefault/Org_Applications/'. $file['Letter_intent'];
...
echo '</script>';*/
        ...
        header('Cache-Control: must-revalidate');
        header('Pragma: public');
        header('Content-Length: ' . filesize('../O-StudentDefault/Org_Applications/' . $file['Letter_intent']));
        readfile('../O-StudentDefault/Org_Applications/' . $file['Letter_intent']);
...
?> 
  ...
  <html lang="en">
   ...
   <li><a class="treeview-item" href="NewOrgApplicants.php">New Organization Applicants</a></li>
              ...
              <li><a class="treeview-item" href="UnrecognizedOrg.php">Non-Funded Organizations</a></li>
            </ul>
          </li> 
          <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-briefcase"></i><span class="app-menu__label">Student Labor</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item" href="LaborApplication.html">Application</a></li>
              <li><a class="treeview-item" href="DTR.html">Daily Time Record</a></li>
              <li><a class="treeview-item" href="Salary.html">Salary</a></li>
            </ul>
          </li>
          ...
          <ul class="app-nav">
            <li>
             ...
             <!-- <li class="app-search">
              ...
              <?php
                $sql_get = mysqli_query($conn, "SELECT * FROM org_applications WHERE status = 0");
            ...
            <ul class="app-notification dropdown-menu dropdown-menu-right">
              ...
              <div class="app-notification__content">
                 ...
                 <?php
                $sql_get1 = mysqli_query($conn, "SELECT * FROM org_applications WHERE status = 0");
                if(mysqli_num_rows($sql_get1)>0){
                    ...
                    <div data-toggle="modal" data-role="orgbtn" id="'.$result['ID'].'">
                      <p class="app-notification__message">New Application for Organization.</p>
                    ...
                    echo '<li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
                    <div>
                      <p class="app-notification__message">No Notifications</p>
       ...
       <h3 class="mb-4">New Organization Applicants</h3>
                        <div class="row">
                          <div class="col-xl">
                            <div class="tile"> 
                              <div class="row">
