          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <div class="float-left"><h4>Prescription</h4></div>
                  </div>
                  <br><br>
                  <div class="row">
                    <div class="col-auto">
                  ...
                  <div class="inline-block">
                    ...
                    <select class="bootstrap-select">
                        ...
                        <option class="select-item" value="2">Medical</option>
                        <option class="select-item" value="3">Dental</option>
                      </select>
                    </div>
              ...
              <tbody>
                    ...
                    $sql = "SELECT * from consultation_details";
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class = "head">  
                        ...
                        <h6 class="font-weight-bold">Date: <span class="font-weight-lighter ml-2"> 2021-07-19</span></h6>
                        <h6 class="font-weight-bold">Name: <span class="font-weight-lighter ml-2">  Rejoice Magbutong</span></h6>
                        <h6  class="font-weight-bold">Gender: <span class="font-weight-lighter ml-2">Female</span></h6>
                        <h6 class="font-weight-bold">Course/Department: <span class="font-weight-lighter ml-2"> BSIT</span></h6>
                        <h6  class="font-weight-bold">Email: <span class="font-weight-lighter ml-2"> r-magbutong@usep.edu.ph</span></h6>
                        <h6 class="font-weight-bold">Contact: <span class="font-weight-lighter ml-2"> 09205303146</span></h6>
                        <br>

                         <h6 class="font-weight-bold">Prescription: </h6> 
                          <h6 class="font-weight-bold">&nbsp; • Axert 2x a day </h6> 
                          <h6 class="font-weight-bold">&nbsp; • Anaprox DS once a day </h6> 
                          <h6 class="font-weight-bold">&nbsp; • Treximet once a day </h6> 
