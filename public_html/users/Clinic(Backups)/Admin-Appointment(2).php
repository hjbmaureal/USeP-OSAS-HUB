...
<div class="row">
 ...
 <?php
                        if(($row['status']) == 'Completed'){
                          echo '<a class="btn btn-warning btn-sm" disabled><i class="fas fa-edit" style="color: white;"></i></a>';
                        }else{
                          echo '<a class="btn btn-warning btn-sm"  data-toggle="modal" data-target=#exampleModalLong2'.$row['id'].'><i class="fas fa-edit" style="color: white;"></i></a>';
