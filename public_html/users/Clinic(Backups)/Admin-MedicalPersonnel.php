          ...
          <?php 
                ...
                if($result = mysqli_query($db,$sql)){
                  ...
                  ?>
                    ...
                    <tr>
                    <td hidden=""><?php echo htmlentities($row['staff_id']);?></td>
                    <td><?php echo htmlentities($row['fullname']);?></td>
                    <td><?php echo htmlentities($row['sex']);?></td>
                    <td><?php echo htmlentities($row['email_add']);?></td>
                    <td><?php echo htmlentities($row['phone_num']);?></td>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Update Medical Personnel Info</h5>
                      ...
                      <div class="modal-body c">
                        <div class="container">
                          <form action="updateMedicalData.php" method="POST"> 

                          <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  <input class="form-control" type="text" id="staff_id_update" name="staff_id_update" hidden="">
                                </div>
                            </div>
                          </div> 
                        ...
                        <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="fullname_update" name="fullname_update" disabled>
                                </div>
                            </div>
                          </div> 
                        ...
                        <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  <input class="form-control" type="text" id="sex_update" name="sex_update" hidden>
                                </div>
                            </div>
                          </div> 
                        ...
                        <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="email_add_update" name="email_update" disabled>
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="form-group">
                                  <label class="control-label">Contact Number</label>
                                  <input class="form-control" type="text" id="phone_num_update" name="contact_update" disabled>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="license_update" name="license_update">
                                </div>
                            </div>
                          </div> 
                           ...
                           <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  <label class="control-label">PTR No.</label>
                                  <input class="form-control" type="text" id="ptr_update" name="ptr_update">
                                </div>
                            </div>
                          </div> 
                          ...
                          <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="s2_update" name="s2_update">
                                </div>
                            </div>
                          </div> 
                      ...
                      <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="updatePersonnel" >Save changes</button>
    ...
    $(this).closest('table').find('td input:checkbox').prop('checked', this.checked);
      ...
      $(document).ready(function(){
        $('.editbtn').on('click', function(){
          ...
          $('#staff_id_update').val(data[0]);
          $('#fullname_update').val(data[1]);
          $('#sex_update').val(data[2]);
          $('#email_add_update').val(data[3]);
          $('#phone_num_update').val(data[4]);
          $('#license_update').val(data[5]);
          $('#ptr_update').val(data[6]);
          $('#s2_update').val(data[7]);
