         ...
         <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-comment-medical"></i><span class="app-menu__label">Request</span><i class="treeview-indicator fa fa-angle-right"></i></a>
           ...
           <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon  fas fa-tools"></i><span class="app-menu__label">Equipment</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a class="treeview-item active" href="Admin-Condition-SE.php">Supply & Equipment Condition</a></li>
            </ul>
          </li>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <h4 class="mb-3 line-head">Equipment Condition</h4>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-auto">
              ...
              <tr>
                    <td>2021-01-04 - 2021-06-30</td>
                    <td>Airconditioning Unit (Koppel)</td>
                    <td>10</td>
                    <td>7</td>
                    <td>2</td>
                    <td>1</td>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <h4 class="mb-3 line-head">Supply Condition</h4>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-auto">
