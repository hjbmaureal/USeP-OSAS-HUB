                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body c">
                        ...
                        <div class="container" style="border: 1px solid black; margin-top: 10px; padding: 20px; border-radius: 10px;">
                              ...
                              <button class="btn btn-danger btn-sm" style="width: 100%; margin-top: 5px; font-size: 10px;" onClick="window.open('user-profiles.html', '_blank'); return false;"><i class="fas fa-exclamation-triangle"></i> View Medical Info/History
                              </button></div>
                              ...
                              <h6 class="font-weight-bold">Patient Type: <span class="font-weight-lighter ml-2"> <?php echo htmlentities($row['patient_type']);?></span></h6>
                         ...
                         <br>
                           ...
                           <h6 class="font-weight-bold">Diagnosis: </h6> 
                            <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" name="diagnosis" rows="4" placeholder="Type diagnosis here..."></textarea>
                                      </div>
                          </div>
                          ...
                          <h6 class="font-weight-bold">Treatment: </h6> 
                            <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" name="treatment" rows="3" placeholder="Type treatment here..."></textarea>
                                      </div>
                            </div>
                          ...
                          <h6 class="font-weight-bold">Remarks: </h6> 
                           <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" name="remarks" rows="3" placeholder="Type your remarks here..."></textarea>
                        <br>

                               <h6 class="font-weight-bold">Prescription: </h6> 
                              <div class="form-row">
                                <div class="form-group col-md-12">
                                      <textarea id="preslist" class="preslist" name="preslist" rows="6" placeholder="&nbsp;Type your Prescription here" style="width: 100%; border-radius: 5px;"></textarea>
                                      </div>
