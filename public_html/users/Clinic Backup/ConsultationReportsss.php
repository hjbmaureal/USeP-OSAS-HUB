              ...
              <div class="tile-body">
                ...
                <div class="float-left"><h4>Consultation Reports</h4></div>
                  ...
                  <div class="row">
                    ...
                    <input  type="text"  name="From" id="From" value="" class="bootstrap-select">

                    <b>Date End</b>
                    <input  type="text" name="To" id="To" value="" class="bootstrap-select" >

                    <input type="submit" name="range" id="range" value="Range" class="btn btn-warning btn-sm verify">
            ...
            <div id="table_clone" style="display: compact">
              <table  class="head">
                <thead>
                  ...
                  <th width="100"></th>
                  <th><center><h4 style="font-family: Arial;">Republic of the Philippines</h4>
                  <h4 style="font-family: Old English Text MT;">University of Southeastern Philippines</h4>
                  <h4 style="font-family: Arial;">Tagum-Mabini Campus</h4>
                  <h4 style="font-family: Arial;">Apokon, Tagum City</h4></center></th>
                  <th width="100"></th>
                  <th width="100"></th>
                  </th>
                  </tr>
                ...
                <tr>
                  <th colspan="6" style="font-family: Arial; color: red;"><h4><center>Medical-Dental Consultation Reports</center></h4></th>
                </tr>
                </table>
                <br>
