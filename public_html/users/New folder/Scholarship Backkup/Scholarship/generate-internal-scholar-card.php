...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl" onload="initClock()">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu font-sec">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="generate-internal-scholar-card.php">Internal</a></li>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="tile">
              <div class="tile-title">
                ...
                <div class="float-left">
                  <h4>Generate Internal Scholarship Card</h4>
                </div>
              ...
              <form id="generate-card-internal-form" method="POST" action="../../php/generate-internal.php">
                ...
                <div class="tile-body">
                  <div id="scholar-table-container">
                      <table class="table table-hover table-bordered" id="generate-card-internal">
                        <thead>
                          <tr>
                            <th>
                              <input type="checkbox" id="select-all-scholar">
                            </th>
                            <th>Surname</th>
                            <th>First Name</th>
                            <th>Middle Name</th>
                        ...
                        <tbody>
                          <?php
                            $query = "SELECT * FROM scholarship_general_info WHERE program_type LIKE 'Internal' AND student_status = 1 ";
                            if(isset($_POST['sortScholarshipProgram']) && isset($_POST['sortCourse']) && isset($_POST['sortSemester']) && isset($_POST['semesterToYear']) && isset($_POST['semesterFromYear'])){
                              ...
                              $query .= " ORDER BY record_status DESC, card_status desc, last_name asc";
                            }
      ...
      <!-- MODAL FOR SIGN SCHOLARS' CARD BUTTON -->
      <div class="modal fade" id="showSelectedModal" tabindex="1" role="dialog" aria-labelledby="addProviderModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title">SIGN INTERNAL SCHOLARSHIP CARD </h3>
              <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
              <!-- FUTURE LAYOUT / DISPLAY -->
            </div>
          </div>
        </div>
      </div>
    ...
    <script type="text/javascript">
      ...
      if(typeof window.history.pushState == 'function') {
          window.history.pushState({}, "Hide", "generate-internal-scholar-card.php");
      }
      //PREVENT RESEND
      ...
      $(document).ready(function(){
        ...
        var table = $('#generate-card-internal').DataTable();
        $('#print-button').click(function(){
          table.column(0).visible(false);
          $('#generate-card-internal').printThis(options);
          setTimeout(() => {
