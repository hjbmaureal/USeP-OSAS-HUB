    ...
    <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><b style="color: red;"><?php echo $count;  ?></b><i class=" fas fa-bell fa-lg mt-2"></i></a>
        <ul class="app-notification dropdown-menu dropdown-menu-right">
              ...
              <div class="app-notification__content">
                 ...
                 <?php 
                $count_sql="SELECT * from notif where user_id='$admin_id'  order by time desc";
              ...
              <li class="app-notification__footer"><a href="../../php/see_all_notif_admin.php?link=Guidance_Admin_Announcements.php">See all notifications.</a></li>
            </ul>
          </li>
                         ...
                         <input type="text" name="announcement_id" id="announcement_id" hidden> 
                            ...
                            <div class="col-sm">
                              <div class="form-group">
                                  <label class="control-label">Date:&nbsp;</label><input class="form-control" type="date" id="date" name="date" required="">
                                </div>
                            </div>
                          </div>
                            <div class="row">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="container">
                          ...
                          <input type="text" name="staff_id2" id="staff_id2"" hidden> 
                            <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
...
document.getElementById('title').style.backgroundColor='#FFCECE';
...
if($(this).val().length == 0){
document.getElementById('content').style.backgroundColor='#FFCECE';
...
//update announcement
      ...
      $.ajax({  
         url: '../../php/fetch_Announcements.php',
        method: 'POST',
        dataType: 'JSON',
        data:{
