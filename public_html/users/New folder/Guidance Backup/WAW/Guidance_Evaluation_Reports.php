...
<!--  TITLE -->
    ...
    <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><b style="color: red;"><?php echo $count2;  ?></b><i class=" fas fa-bell fa-lg mt-2"></i></a>
            <ul class="app-notification dropdown-menu dropdown-menu-right">
              ...
              <li class="app-notification__footer"><a href="../../php/see_all_notif_admin.php?link=Guidance_Evaluation_Reports.php">See all notifications.</a></li>
            </ul>
          </li>
   ...
   $("#print-button").on("click", function () {
           ...
           const dataUrl3 = document.getElementById('myChart3').toDataURL();  
            ...
            htmlToPrint += tab.outerHTML;
                ...
                windowContent += '<body>';
                windowContent += '<div id="title" style="margin-top:48px;"><div align="center"><img src="../../images/logo.png" alt="USeP Logo" height="100px" width="100px"></div></div>';
        ...
        <script type="text/javascript">
                $(document).ready(function(){
                  ...
                  $("#filtermonth").on('change', function(){
                    ...
                    if (filtermonth2!='to') {
                    $.ajax({
                          url:"../../php/Guidance_Evaluation_Report_filter.php",
                          type:"POST",
