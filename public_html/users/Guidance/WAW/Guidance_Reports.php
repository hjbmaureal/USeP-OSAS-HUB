 ...
 <?php 
  if (isset($_POST['create_pdf'])) {
    ...
    $sql="SELECT intake_form.*, guidance_appointments.*, student.*, indv_counselling.remarks, student.Student_id as stud_id, course.name as course, mode_of_communication.communication_mode from intake_form join indv_counselling on indv_counselling.intake_id=intake_form.intake_id JOIN guidance_appointments on guidance_appointments.appointment_id=indv_counselling.appointment_id
                        ...
                        where guidance_appointments.status_id='3'";
  }if ($mode=='all' && $from=='all' && $to=='all') {
    $sql="SELECT intake_form.*, guidance_appointments.*, student.*, indv_counselling.remarks, student.Student_id as stud_id, course.name as course, mode_of_communication.communication_mode from intake_form join indv_counselling on indv_counselling.intake_id=intake_form.intake_id JOIN guidance_appointments on guidance_appointments.appointment_id=indv_counselling.appointment_id
                        left join student on student.Student_id=intake_form.Student_id
                        left join course on course.course_id=student.course_id
                        left join mode_of_communication on guidance_appointments.mode_id=mode_of_communication.mode_id
      ...
      $sql="SELECT intake_form.*, guidance_appointments.*, student.*, indv_counselling.remarks, student.Student_id as stud_id, course.name as course, mode_of_communication.communication_mode from intake_form join indv_counselling on indv_counselling.intake_id=intake_form.intake_id JOIN guidance_appointments on guidance_appointments.appointment_id=indv_counselling.appointment_id
                        ...
                        left join course on course.course_id=student.course_id
                        left join mode_of_communication on guidance_appointments.mode_id=mode_of_communication.mode_id
                        where guidance_appointments.status_id='3' and DATE_FORMAT(guidance_appointments.appointment_date, '%m') BETWEEN '$from' and '$to'";
  }if ($mode!='all' && $from=='all' && $to=='all') {
      $sql="SELECT intake_form.*, guidance_appointments.*, student.*, indv_counselling.remarks, student.Student_id as stud_id, course.name as course, mode_of_communication.communication_mode from intake_form join indv_counselling on indv_counselling.intake_id=intake_form.intake_id JOIN guidance_appointments on guidance_appointments.appointment_id=indv_counselling.appointment_id
                        left join student on student.Student_id=intake_form.Student_id
                        left join course on course.course_id=student.course_id
                        left join mode_of_communication on guidance_appointments.mode_id=mode_of_communication.mode_id
                        where guidance_appointments.status_id='3' and guidance_appointments.mode_id = '$mode'";
 }if ($mode!='all' && $from!='all' && $to!='all') {
       $sql="SELECT intake_form.*, guidance_appointments.*, student.*, indv_counselling.remarks, student.Student_id as stud_id, course.name as course, mode_of_communication.communication_mode from intake_form join indv_counselling on indv_counselling.intake_id=intake_form.intake_id JOIN guidance_appointments on guidance_appointments.appointment_id=indv_counselling.appointment_id
                        left join student on student.Student_id=intake_form.Student_id
                        left join course on course.course_id=student.course_id
                        left join mode_of_communication on guidance_appointments.mode_id=mode_of_communication.mode_id
                        where guidance_appointments.status_id='3' and guidance_appointments.mode_id = '$mode' and DATE_FORMAT(guidance_appointments.appointment_date, '%m') BETWEEN '$from' and '$to'";
  }
   ...
   <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><b style="color: red;"><?php echo $count2;  ?></b><i class=" fas fa-bell fa-lg mt-2"></i></a>
            <ul class="app-notification dropdown-menu dropdown-menu-right">
              ...
              <div class="app-notification__content">
                ...
                $count_sql="SELECT * from notifications where user_id='$admin_id'  order by _time desc";
              ...
              <li class="app-notification__footer"><a href="../../php/see_all_notif_admin.php?link=Guidance_Reports.php">See all notifications.</a></li>
            </ul>
          </li>
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
              <li><a class="dropdown-item" href="Guidance_AdminUser.html"><i class="fa fa-user fa-lg"></i> Profile</a></li>
                ...
                $(document).ready(function(){
                  $("#filtermonth").on('change', function(){
                    ...
                    $.ajax({
                          ...
                          type:"POST",
                          data:{from : filtermonth, to : filtermonth2, mode: mode},
                          beforeSend:function(){
...
<script type="text/javascript">
 ...
 $("#print-button").on("click", function () {
            ...
            printWindow.document.write('<div align="center" style="font-size:16px;">In-take Interview/Counselling Summary<br></div>');
