...
/*      $obj_pdf->SetTitle("Export HTML Table data to PDF using TCPDF in PHP");  */
      ...
      $content .= '
        ...
        <div align="center" style="font-size:16px;"><b>University of Southeastern Philippines</b><br><i>University Guidance and Assessment Center</i><br><br><span style="font-size: 12px;">Summary of Group Guidance Reports</span></div></div>
  ...
  <style>
   ...
   <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><b style="color: red;"><?php echo $count2;  ?></b><i class=" fas fa-bell fa-lg mt-2"></i></a>
            <ul class="app-notification dropdown-menu dropdown-menu-right">
              ...
              <li class="app-notification__footer"><a href="adminSeeAllNotif.php?link=Guidance_GroupGuidance_Reports.php">See all notifications.</a></li>
            </ul>
          </li>
