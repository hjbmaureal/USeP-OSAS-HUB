...
?>
                  ...
                  <td colspan="4" align="justify">
                    ...
                    <td colspan="2">35. Date Accomplished <br><i class="fa fa-caret-left" aria-hidden="true"></i>
                             ...
                             <input type="text" name="date_accomplished" class="intake datepicker" value="<?php echo $prorow['date_filed']; ?>" id="date_accomplished" placeholder="YYYY/MM/DD" autocomplete="off" ><br>
                    </td>
                  </tr>
                </table>
                <br>
