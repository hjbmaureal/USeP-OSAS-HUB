 ...
 ?> 
        <div id="HoiPrint?<?php echo $referral_id;?>"><div class="modal-body" id="printForm">
                            ...
                            <table width="90%" align="center" style="margin-top:30px;">
                              ...
                              <tr align="center">
                                ...
                                <td>
                                  <div>
                                    <?php if ($image_data!='') { ?>
                                      <img style="margin-left: 60px; margin-top: -6%; margin-right: 1px; position: absolute;" width="100" height="100" src="data:image/jpeg;base64,<?php echo base64_encode( $image_data ); ?>" />
                                    <?php }else{ ?>
                                      <img style="margin-left: 60px; margin-top: -3%; margin-right: 1px; position: absolute;" width="100" height="50" src="image/Defalt_Esig.png" />
                                    <?php }?>
                                
                                  <input type="text" id="vto_admin" name="vto_admin" value="<?php echo $row['fname'].' '.$row['lname'];?>" placeholder="" readonly="" style=" text-align: center; width:220px; border-style:solid; border-left: none; border-top: none; border-right: none;" >
