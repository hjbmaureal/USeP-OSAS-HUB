...
/*-------------------------------------------------------------------------------------------------------------------*/
  ...
  <html lang="en">
       ...
       <div class="row">
        <div class="col-sm-3">
          <div class="widget-small primary"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              ...
              <?php 
                $sql = mysqli_query($conn, "Select * from student WHERE date_verified IS NULL") or die(mysqli_error($conn));
                $row_cnt = mysqli_num_rows($sql);
              ?>
              <p><b><?php echo $row_cnt; ?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="widget-small info"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              ...
              <?php 
                $sql = mysqli_query($conn, "Select * from student") or die(mysqli_error($conn));
                $row_cnt = mysqli_num_rows($sql);
              ?>
              <p><b><?php echo $row_cnt; ?></b></p>
            </div>
          ...
          <div class="widget-small danger "><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              ...
              <?php 
                $sql = mysqli_query($conn, "Select * from staff") or die(mysqli_error($conn));
                $row_cnt = mysqli_num_rows($sql);
              ?>
              <p><b><?php echo $row_cnt; ?></b></p>
            </div>
        ...
        <div class="col-md-3">
          <div class="widget-small warning"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4>Active Staff Accounts</h4>              
              <?php 
                $sql = mysqli_query($conn, "Select * from staff WHERE date_verified IS NULL") or die(mysqli_error($conn));
                $row_cnt = mysqli_num_rows($sql);
              ?>
              <p><b><?php echo $row_cnt; ?></b></p>
            </div>
    ...
    $(this).closest('table').find('td input:checkbox').prop('checked', this.checked);
      ...
      if ($notif_count!=0) 
        { 
          echo '<script>swal("Notification Alert!", "You have '.$notif_count.' unread notification/s!", "success")</script>';
        }
      ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You have <?php echo $notif_count;  ?> unread notifications</p><br>
