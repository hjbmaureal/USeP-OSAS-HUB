                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-sm">
                          ...
                          <div class="form-group col-sm-3">
                            <p>Course
                              <select class="form-control" id="course" name="course" >
                                <option value="<?php echo $res['course_id']; ?>" selected><?php echo $res['coursetitle']; ?></option>
                               <?php
                          ...
                          <div class="form-group col-sm-3">
                            <p>Year Level
                              <select class="form-control" id="level" name="level">                                
                                <option value="<?php echo $res['year_level']; ?>" selected><?php echo $res['year_level']; ?></option>
                        ...
                        <h6 class="font-weight-bold">If A Student Organization Governor/President</h6>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-sm-3">
                            <p>Student Organization
                              <select class="form-control" id="orgname" name="orgname">
                                <?php
                                $nameorg = $res['school_org']; 
                                  $results1=mysqli_query($conn, "SELECT org_id FROM school_organization WHERE org_name = '$nameorg'");
                                  $col = mysqli_fetch_array($results1)


                                  ?>

                                <option value="<?php echo $col['org_id']; ?>" selected><?php echo $res['school_org']; ?></option>
                               <?php
                                  $result=mysqli_query($conn, "SELECT * FROM school_organization");               
                                  while($resuu = mysqli_fetch_array($result)) { 
                                      $value= $resuu['org_id']; ?>
                                      <option class="select-item" value="<?php echo $value; ?>"><?php echo $resuu['org_name'];?></option>
                                <?php } ?>
                              </select>
                          </div>
                          </p>
                          ...
                          <?php } 
                            ...
                            <div class="form-group col-sm-3">
                            <p>Student Organization
                              <select class="form-control" id="orgname" name="orgname" disabled> 
                                <?php
                                $nameorg = $res['school_org']; 
                                  $results1=mysqli_query($conn, "SELECT org_id FROM school_organization WHERE org_name = '$nameorg'");
                                  $col = mysqli_fetch_array($results1)
                                  ...
                                  ?>
                                <option value="<?php echo $col; ?>" selected><?php echo $res['school_org']; ?></option>
                               <?php
                                  $result=mysqli_query($conn, "SELECT * FROM school_organization");               
                                  while($resuu = mysqli_fetch_array($result)) { 
                                      $value= $resuu['org_id']; ?>
                          ...
                          <div class="form-group col-sm-3">
                            <p>Living With
                              <select class="form-control" id="living" name="living" >
                                <option value="<?php echo $res['living_with']; ?>" selected><?php echo $res['living_with']; ?></option>
