            ...
            <div class="tile">
              <div class="tile-body">
                ...
                <div class="table-responsive">
                  ...
                  <?php
                  include("conn.php");
                  $tab = mysqli_query($conn,"SELECT * FROM studentdetails");
        ...
        while($res = mysqli_fetch_array($tab)) {         
            ...
            <td><?php echo $res['account_status']; ?></td>
                   ...
                   ?>
                          ...
                          <button data-target="#enable-dialog<?php echo $res['student_id']; ?>" role="button" class="btn btn-success btn-sm" data-toggle="modal" id="formid" onclick="toggleClasses()" >Activate</button>
