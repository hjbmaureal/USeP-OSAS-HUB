                         ...
                         <div class="row">
                          ...
                          <div class="col">
                           <div class="inline-block float ml-2 btn-group">
                            <button type="button" class="btn btn-danger  btn-sm button-sm150 mtop" style="z-index:0" data-toggle="modal" data-target="#ModalAdd"><i class="mr-1 fas fa-plus"></i> Add</button></div> 
                              <?php include('php/staff_add_modal.php'); ?>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col mt-1">
                        ...
                        echo '<input type="text" name="sql_val" id="sql_val" style="width:1000px;" value="'.$sql.'" hidden>';
                              ...
                              while($res = mysqli_fetch_array($tab)) {         
                                ...
                                <tr>
                                  ...
                                  <?php 
                                  include('php/staff_view_modal.php');
                                  include('php/staff_edit_modal.php'); ?>
                                  ...
                                  <td>
                                    ...
                                    <?php 
                                            if($res['account_status'] == "Active"){?>
                                              ...
                                              <a class="btn btn-danger btn-sm" data-toggle="modal" a href="#staff_verify<?php echo $res['staff_id']; ?>">Disable</a>
                                            <?php }else{?>
                                              <a class="btn btn-success btn-sm" data-toggle="modal" a href="#staff_verify<?php echo $res['staff_id']; ?>">Enable</a>
                                              <button role="button" class="btn btn-danger btn-sm" data-toggle="modal" data-role="prodbtn2" disabled="">Disable</button>


                                              <?php
                                            } include('php/staff_verify.php'); ?> 
                            ...
                            $("#sel2").on('change',function() {
                              ...
                              $.fn.dataTable.ext.search.push(
                                function(settings, data, dataIndex) {
                                  ...
                                  return $(table.row(dataIndex).node()).children("td:nth-child(3)").text()==filterItem;
                                }
                                );
                              if ("All"==filterItem) {
                               $.fn.dataTable.ext.search.pop();
