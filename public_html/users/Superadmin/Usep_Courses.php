        ...
        <ul class="app-menu font-sec">
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-sitemap"></i><span class="app-menu__label">Miscellaneous</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a class="treeview-item active" href="Usep_Courses.php">USeP Courses</a></li>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="tile">
                            <div class="tile-body">
                              <div>
                                <div class="float-left"><h4>Usep Courses</h4></div>
                              </div>
                              <br><br>
                              <div class="row">
                                <div class="col-sm">
                                ...
                                <div class="table-responsive">
                                  ...
                                  <table class="table table-hover table-bordered" id="sampleTable">
                                    <thead>
                                      <tr>
                                        <th>ID</th>
                                        <th style="min-width: 250px;">Course Name</th>
                                        <th>Acronym</th>
                                        <th style="min-width: 100px;">Major</th>
                                        <th>College</th>
                                        <th>Status</th>
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                      include('../../conn.php');
                                      $query = "SELECT course.course_id, course.name, course.title, course.major, course.status, course.student_type, course.college_id, college.title as 'coltitle', college.description as 'coldesc' from course JOIN college ON course.college_id = college.college_id "; 
                                      ...
                                      while($res = mysqli_fetch_array($result)){         
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $res['major']; ?></td>
                                          <td><?php echo $res['coltitle']; ?></td>
                                          <td><?php echo $res['status']; ?></td>          
                                          <td>
                                            <button class="btn btn-info btn-sm" data-toggle="modal" a href="#details<?php echo $res['course_id']; ?>"><i class="fas fa-eye"></i></button>
                                            <?php include('php/usep_course_modal.php'); ?>


                                            <!-- for edit -->
                                            <a class="btn btn-warning btn-sm" data-toggle="modal" a href="#detail<?php echo $res['course_id']; ?>">  <i class="fas fa-edit" data-toggle="modal" data-target="#cordownload"></i></a>
                                            <?php include('php/course_modal.php'); ?>
                                            <!--end of edit part-->
                                            ...
                                            if($res['status'] == "Active"){?>
                                              ...
                                              <a class="btn btn-danger btn-sm" data-toggle="modal" a href="#course_verify<?php echo $res['course_id']; ?>">Disable</a>
                                            <?php }else{?>
                                              <a class="btn btn-success btn-sm" data-toggle="modal" a href="#course_verify<?php echo $res['course_id']; ?>">Enable</a>
                                              <button role="button" class="btn btn-danger btn-sm" data-toggle="modal" data-role="prodbtn2" disabled="">Disable</button>


                                              <?php
                                            } include('php/course_verify.php'); ?>   
                                          </td>              
                                        </tr>
                                        <?php
                                      }
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="form-group col-sm">
                                    <p>Course Name
                                      <input class="form-control" type="text" id="major" name="cname" required="">
                                    </p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="form-group col-sm">
                                    <p>Acronym
                                      <input class="form-control" type="text" id="major" name="cacronym" required="">
                                    </p>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="form-group col-sm">
                                    <p>Course Major
                                      <input class="form-control" type="text" id="major" name="cmajor" required="">
                                    </p>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="form-group col-sm">
                                    <p>College  
                                      <select class="form-control" id="degree" name="ccol" required=""> 
                                        <option value="" selected="" disabled="">Select Option</option>
                                        <?php 
                                        $query = "SELECT * FROM college"; 
                                        $result = mysqli_query($conn, $query);
                                        while($res = mysqli_fetch_array($result)){   ?>
                                          <option value="<?php echo $res['college_id'] ?>"><?php echo ' ' .$res['description']. ' (' .$res['title']. ')'; ?></option>
                                        <?php } ?>
                                  ...
                                  <div class="row">
                                    <div class="form-group col-sm">
                                      <p>Type  
                                        <select class="form-control" id="degree" name="ctype" required=""> 
                                          <option value="" selected="" disabled="">Select Option</option>
                            ...
                            $("#sel2").on('change',function() {
                              ...
                              $.fn.dataTable.ext.search.push(
                                function(settings, data, dataIndex) {
                                  ...
                                  return $(table.row(dataIndex).node()).children("td:nth-child(6)").text()==filterItem;
                                }
                                );
                              if ("All"==filterItem) {
                               $.fn.dataTable.ext.search.pop();
