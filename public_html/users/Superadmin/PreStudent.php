    ...
    <head>
      ...
      <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
        ...
        <ul class="app-menu font-sec">
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon far fa-registered"></i><span class="app-menu__label">Pre Registration<b style="background-color:#FF0000; padding:4px 6px;font-size:10px; margin-left:10px; border-radius:100%;"><?php echo $prestudent_count+$prealumni_count;  ?></b></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item active" href="PreStudent.php">Student Accounts<b style="background-color:#FF0000; padding:4px 6px;font-size:8px; margin-left:10px; border-radius:100%;"><?php echo $prestudent_count;  ?></b></a></li>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <div class="float-left"><h4>Pre Student Registration</h4></div>
                  </div>
                  <br><br>
                <!-- Table -->
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-hover table-bordered" id="sampleTable2">
                    <thead>
                      ...
                      <th class="max">Date Registered</th>
                      <th>Form</th>
                      <th>COR</th>
                      <th>Status</th>
                    </tr>
                  ...
                  <?php
                  include("../../conn.php");
                 $run = mysqli_query($conn, "SELECT * FROM student where date_verified is null");
        while($res = mysqli_fetch_array($run)) {       
            ?>     
            <tr>
            <td><?php echo $res['reg_id']; ?></td>
            <td><?php echo $res['first_name']." ".$res['middle_name']." ".$res['last_name']." ".$res['suffix'] ;?></td>
            <td><?php echo $res['email_add']; ?></td>
            <td><?php echo $res['phone_number']; ?></td>  
            <td><?php echo $res['date_submitted']; ?></td>           

                     <td>

                   <button class="btn btn-info btn-sm" data-toggle="modal" a href="#Details<?php echo $res['Student_id']; ?>"><i class="fas fa-eye"></i></button>
                      <?php include('include/PreStudent-view.php'); ?>
                    </td>   

                    <td>
                      <a class="btn btn-warning btn-sm" href="<?php echo $res['cor']; ?>"><i class="fas fa-download" ></i></a>
                    </td>
                    <?php   
                    if(empty($res["date_verified"])){?>
                            <td>
                      <button class="btn btn-danger btn-sm verify" data-toggle="modal" a href="#studentdetails<?php echo $res['Student_id']; ?>">Verify</button>
                      <?php include('include/PreStudent-verify.php'); ?>
                    </td>   
                  ...
                  <?php 
                   ...
                   echo'<td>
                                <button class="btn btn-danger btn-sm verify" disabled="disabled">Verified</button>
                        </td>';}
                    ?>
                  </tr>
