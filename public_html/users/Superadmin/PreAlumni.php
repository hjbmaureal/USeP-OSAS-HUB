        ...
        <ul class="app-menu font-sec">
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon far fa-registered"></i><span class="app-menu__label">Pre Registration<b style="background-color:#FF0000; padding:4px 6px;font-size:10px; margin-left:10px; border-radius:100%;"><?php echo $prestudent_count+$prealumni_count;  ?></b></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a class="treeview-item active" href="PreAlumni.php">Alumni Accounts <b style="background-color:#FF0000; padding:4px 6px;font-size:8px; margin-left:10px; border-radius:100%;"><?php echo $prealumni_count;  ?></b></a></li>
            </ul>
          </li>          
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <div class="float-left"><h4>Pre Alumni Registration</h4></div>
                  </div>
                  <br><br>
                <!-- Table -->
                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                  <?php
                 $run = mysqli_query($conn, "SELECT * FROM alumni where date_verified is null");
        while($res = mysqli_fetch_array($run)) {       
            ...
            <td><?php echo $res['date_registered']; ?></td>           
                   ...
                   <button class="btn btn-info btn-sm" data-toggle="modal" a href="#Details<?php echo $res['id']; ?>"><i class="fas fa-eye"></i></button>
                      <?php include('include/PreAlumni-view.php'); ?>
                    </td>   
                    ...
                    if(empty($res["date_verified"])){?>
                            <td>
                      <button class="btn btn-danger btn-sm verify" data-toggle="modal" a href="#studentdetails<?php echo $res['id']; ?>">Verify</button>
                      <?php include('include/PreAlumni-verify.php'); ?>
                    </td>   
