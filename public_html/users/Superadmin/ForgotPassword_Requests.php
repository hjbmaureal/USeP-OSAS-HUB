...
$headers = "From: jizterbonza@gmail.com";
...
$result_mail= mail($email_to, $subject, $message, $headers);
...
if($result2 && $result_mail && $result3){
          //echo '<script>alert("Password successfully updated and send via Email!")</script>';
         // echo '<script>swal("Password successfully updated and send via Email!", "success")</script>';
          echo '<script>
   swal({
  title: "Password successfully updated and send via Email!",
  ...
  type: "success"
          ...
          //echo '<script>swal("Identification not recognized. Please try again.", "warning")</script>';
          echo '<script>
   swal({
  title: "Identification not recognized. Please try again.",
...
?>
      ...
      <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
        ...
        <ul class="app-menu font-sec">
          ...
          <li><a class="app-menu__item active" href="ForgotPassword_Requests.php"><i class="app-menu__icon  fas fa-database"></i><span class="app-menu__label">Forgot Password Requests<b style="background-color:#FF0000; padding:4px 6px;font-size:8px; margin-left:10px; border-radius:100%;"><?php echo $count;  ?></b></span></a></li>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                 <div class="row">
                  <div class="col">
                      <div class="float-left"><h4>Forgot Password Requests</h4></div>
                  </div>
                </div>
...
<div class="modal fade" id="action-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header"> <b><input type="text" name="student_id" id="student_id" readonly style="background-color: transparent;border-color: transparent;"></b><br></div>
        <div class="modal-body">
         
          <input type="hidden" class="form-control" id ="last_name" readonly>
          <input type="hidden" class="form-control" id ="first_name" readonly="">
          <input type="hidden" class="form-control" id ="middle_name" readonly="">
          <b>Enter the user's new password:</b><br><input type="text" class="form-control" name="new_password" placeholder="Enter new Password">
        </div>
         <div class="modal-footer">
