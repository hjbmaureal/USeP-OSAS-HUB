 <form method="POST" action="php/college_act-dis.php">    
<div class="modal fade " id="college_verify<?php echo $res['college_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-body c">
                                <div class="container">
                                  ...
                                  <?php include('../../conn.php');
                                      $sqlselect=mysqli_query($conn,"SELECT * FROM college where college_id='".$res['college_id']."'");
                                      $prorow=mysqli_fetch_array($sqlselect);
                                  ?>

                                  <input type="hidden" name="eid" value="<?php echo $res['college_id']; ?>">
