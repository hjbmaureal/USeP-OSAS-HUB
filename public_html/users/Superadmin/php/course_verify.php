 <form method="POST" action="php/course_act-dis.php">    
<div class="modal fade " id="course_verify<?php echo $res['course_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-body c">
                                <div class="container">
                                  ...
                                  <?php include('../../conn.php');
                                      $sqlselect=mysqli_query($conn,"SELECT * FROM course where course_id='".$res['course_id']."'");
                                      $prorow=mysqli_fetch_array($sqlselect);
                                  ?>

                                  <input type="hidden" name="eid" value="<?php echo $res['course_id']; ?>">
