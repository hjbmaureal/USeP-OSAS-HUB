      ...
      <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
        ...
        <ul class="app-menu font-sec">
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon far fa-registered"></i><span class="app-menu__label">Account Records</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item active" href="AlumniAccounts.php">Alumni Accounts</a></li>
      ...
      <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
       ...
       <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <div class="float-left"><h4>Alumni Accounts</h4></div>
                  </div>
                  <br><br>
                  <div class="row">
                    <div class="col-auto">
        ...
        while($res = mysqli_fetch_array($tab)) {         
            ...
            <td><?php echo $res['last_sy_attended']; ?></td>
            <td><?php echo $res['account_status']; ?></td>
                                         <!-- a href="#details<?php //echo $res['student_id']; ?>" -->
                     <td>
                      <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModalLong<?php echo $res['id']; ?>"><i class="fas fa-eye"></i></button>
                      <button data-target="#exampleModal<?php echo $res['id']; ?>" role="button" class="btn btn-warning btn-sm" data-toggle="modal"><i class="fas fa-edit"></i></button>

                      <?php include('include/Alumni-view.php'); ?>
                   ...
                   <?php 
                    if($res['account_status'] == "Active"){ ?>
                        ...
                        <button data-target="#disable-dialog<?php echo $res['id']; ?>" role="button" class="btn btn-danger btn-sm" data-toggle="modal" id="formid"  onclick="toggleClasses()">Disable</button>
                        
                        
                    <?php                    
                     include('include/Alumni-disable.php');
                   }
                   else{
                   ?>
                      ...
                      <?php
                      include('include/Alumni-enable.php');
                    }
                     include('include/Alumni-edit.php');
                      ?>
