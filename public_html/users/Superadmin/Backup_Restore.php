    ...
    <head>
      ...
      <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
        ...
        <ul class="app-menu font-sec">
          ...
          <li><a class="app-menu__item active" href="Backup_Restore.php"><i class="app-menu__icon  fas fa-database"></i><span class="app-menu__label">Backup and Restore</span></a></li>
      ...
      <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="col-md">
          ...
          <div class="tile">
            <h3 class="tile-title">BACK UP</h3>
                        <div class="tile-footer"></div>
            <div class="tile-body" ><a class="btn btn-danger btn-lg" href="database-backup.php" target="_blank"><i class="fa fa-database fa-lg"></i> Back Up Database</a> 
              </div>
        ...
        <div class="col-md">
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal"> <i class="fa fa-database fa-lg"> </i> Restore Database</button>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>To Restore the database needed for the system please check first the current database still exist.</p>
                    <p class="text-secondary"><small>Check the current database if it is still on active.</small></p>
                    </div>
                    <div class="modal-footer">
