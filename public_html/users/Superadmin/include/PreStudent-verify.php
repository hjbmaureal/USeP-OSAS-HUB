<form method="post" action="php/PreStudent-VerifyAcc.php">
                          ...
                          <span aria-hidden="true">&times;</span></button></div>
                              <div class="modal-body c">
                                <div class="container">
                                  ...
                                  ?>
                                  <h5 class="modal-title" id="exampleModalLongTitle"> Do you want to verify <?php echo $prorow['first_name']." ".$prorow['last_name']."".$prorow['middle_name']; ?> account?</h5>
                                  <br>
