 ...
 include("../../conn.php");
$uid = $res['Student_id'];
$query=mysqli_query($conn,"SELECT * FROM studentdetails where student_id='$uid' ");
                ...
                <div class="modal-dialog modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel"><?php echo $res['Student_id']; ?></h5>
                ...
                <h5 class="font-weight-bold">Family Information</h5>
                          ...
                          <div class="col">
                            <h6 class="font-weight-bold">Other's Please Specify :</h6>
                             <h6 class="font-weight-lighter "> <?php echo $row['others_specify'];?></h6>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm">
