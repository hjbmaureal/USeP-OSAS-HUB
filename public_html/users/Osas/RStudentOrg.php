    ...
    <head>
      ...
      <ul class="app-menu font-sec">
        ...
        <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-briefcase"></i><span class="app-menu__label">Reports</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item active" href="RStudentOrg.php">Student Organization</a></li>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <div class="float-left"><h4>Student Organization Summary</h4></div>
                  </div>
                  <br><br>
                  <div class="row">
                        </div>
              ...
              <div class="inline-block">
                    ...
                    <select class="bootstrap-select" name="yr_drpdwn" id="yr_drpdwn">
                          ...
                          <?php
                                    ...
                                    $sql="SELECT DISTINCT year(date) as get_yr FROM org_filess";
                ...
                <div class="inline-block">
                    ...
                    <select class="bootstrap-select" name="month_drpdwn" id="month_drpdwn">
                          ...
                          <option class="select-item"<?php if(isset($_POST['month_drpdwn']) && $_POST['month_drpdwn'] == 12 ) echo 'selected'?> value="12">December</option>
                              ...
                              <div class="inline-block">
                              Org. Name <br>
                              <select name="sortOrgname" id="sortOrgname" class="bootstrap-select size-150px">
                               <option class="select-item"  value="0" >All</option>
                                <?php
                                    
                                    $sql="SELECT DISTINCT org FROM org_filess";
                                    $result = mysqli_query($conn,$sql);
                                    while($row=mysqli_fetch_array($result)){
                                     echo "<option class='select-item'";
                              ...
                              <div class="inline-block">
                              Org Type <br>
                              <select name="orgtypeDropdown" id="orgtypeDropdown" class="bootstrap-select size-150px">
                              <option class="select-item" value="0">All</option>
                               <?php
                                    
                                    
                                    $sql="SELECT DISTINCT type FROM org_filess";
                                    $result = mysqli_query($conn,$sql);
                                    while($row=mysqli_fetch_array($result)){
                                          echo "<option class='select-item'";
                  ...
                  <form method="POST" action="PrintReports.php" target="_blank">
                    <div class="inline-block float mr-3 mt-3">
                      <button class="btn btn-success" name="submit_org" type="submit" id="submit_org" style="margin-right: 12px;" target="_blank"><i class="fas fa-print"></i>&nbsp; Print</button>
                    </div>
                ...
                <div class="table-responsive">
                  ...
                  <?php
                      ...
                      $sql="SELECT * FROM org_filess where id != 0";

                       if(isset($_POST['sortOrgname']) || isset($_POST['orgtypeDropdown'])){
                          $org_name = $_POST['sortOrgname'];
                          $org_type = $_POST['orgtypeDropdown'];
                          $yr_comp = $_POST['yr_drpdwn'];
                          $mont_comp = $_POST['month_drpdwn'];

                        if ($yr_comp != "0") {
                          # code...
                          $sql .= " AND year(date) = '$yr_comp' ";
                        }
                        if ($mont_comp != "0") {
                          # code...
                          $sql .= " AND month(date) = '$mont_comp' ";
                        }
                       if ($org_name!= "0") {
                         # code...
                         $sql.=" AND org ='$org_name' ";
                        }
                          if ($org_type!= "0") {
                          # code...
                         $sql.=" AND type ='$org_type' ";
