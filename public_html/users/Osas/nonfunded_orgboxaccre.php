<!-- MODAL VIew -->
                              ...
                              <!--<div class="remarks-container container p-3">-->
                                ...
                                <br>
                                  ...
                                  <div class="card-body fs2">
                                    ...
                                    <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&AccomRep=<?php echo $res['AccomRep'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                                  </div>
                                </div>
                              </div>
                               <?php }
                              ...
                              <div class="col-sm">
                                ...
                                <br>
                                  ...
                                  <div class="card-body fs2">
                                    ...
                                    <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&AFS=<?php echo $res['AFS'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                                  </div>
                                </div>
                              </div>
                              <?php }
                              ...
                              <?php }
                                ...
                                <br>
                                  ...
                                  <div class="card-body fs2">
                                    ...
                                    <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&Lists_officers=<?php echo $res['Lists_officers'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                                  </div>
                                </div>
                              </div>
                              <?php }
                           ...
                           <div class="col-sm">
                              ...
                              <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&Lists_members=<?php echo $res['Lists_members'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                              </div>
                            </div>
                          </div>
                           <?php }
     ...
     <div class="row" style="">
                            ...
                            <div class="col-sm">
                              ...
                              <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&Aff_adviser=<?php echo $res['Aff_adviser'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                              </div>
                            </div>
                          </div>
                          <?php }
                          ...
                          <div class="col-sm">
                            ...
                            <div class="card-body fs2">
                             ...
                             <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&Aff_high_officer=<?php echo $res['Aff_high_officer'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                            </div>
                          </div>
                        </div>
                        <?php }
                        ...
                        <div class="col-sm">
                          ...
                          <div class="card-body fs2">
                            <a href="UnrecognizedOrg.php?file_id=<?php echo $res['org_id'];?>&AFP=<?php echo $res['AFP'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                          </div>
                        </div>
                      </div>
                      <?php }
                      ...
                      <div class="col-sm">
                          ...
                          <div class="card-body fs2">
                            <a href="UnrecognizedOrg.php?file_id<?php echo $res['org_id'];?>&CBL_logo=<?php echo $res['CBL_logo'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                          </div>
                        </div>
                      </div>
                      <?php }
