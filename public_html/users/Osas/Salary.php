...
<br>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <div class="float-left"><h4>Student Labor Salary</h4></div>
                  </div>
                  <br><br>
                  <div class="row">
                    <div class="col-auto">
   ...
   <div class="table-bd">
                <div class="table-responsive">
                  <br>
                  <table class="table table-hover table-bordered" id="sl-table">
                    <thead>
                      <tr>
                        <th>SL ID</th>
                    ...
                    <tbody>
                      <!-- <tr>
                        ...
                        <td class="text-center align-middle">
                          <a class="btn btn-info btn-sm" href="salarystudent.html"><i class="fas fa-eye"></i></a>
                        </td>
                      </tr> -->
                    </tbody>
                    <tfoot>
                ...
                columns : [
                  ...
                  { 
                    ...
                    render : function ( data, type, row){
                      ...
                      var str = '<a class="btn btn-info btn-sm" href="salarystudent.php?id='+app_id+'"><i class="fas fa-eye"></i></a>';
                      return str;
                    }
                  }
                ],
