<!-- MODAL VIew -->
                             ...
                             $results = mysqli_query($conn, "SELECT file FROM remarks_apply WHERE status=1 and org_name='$org'");       
                              ...
                              <label name="gov">Student Org. President/Governor: &emsp; <input type="text"  style="border:none;width: 400px;" name="gov" value="<?php echo $res['Org_pres_gov'];?>"></label><br>
                              <label name="adviser">Student Org. Adviser: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" style="border:none; width: 400px;" name="adviser" value="<?php echo $res['Org_adviser'];?>"></label><br>
                              <label name="type">Organization Type: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" name="type" style="border:none; width: 400px;" value="<?php echo $res['Type']; ?>"> </label><br>
                            ...
                            <div class="col-sm">
                              ...
                              <a href="UnrecognizedOrg.php?file_id=<?php echo $res['ID'];?>&AccomRep=<?php echo $res['AccomRep'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                              </div>
                            </div>
                          </div>
                          <?php }
                          ...
                          <div class="col-sm">
                            <div class="tile card text-center h120" style="height:130px; background: #EFE0DE;">
                             <div class="card-body fs1">
                               <p class="card-text" style="font-size: 12px;margin-bottom:0"><b>Action Plan</b></p>
                                <br>
                              <p class="card-text" style="font-size: 12px;margin-bottom:0"><b>Action Plan</b></p>
                                <br>
                            ...
                            <div class="card-body fs2">
                             ...
                             <a href="UnrecognizedOrg.php?file_id=<?php echo $res['ID'];?>&ActionPlan=<?php echo $res['ActionPlan'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                            </div>
                          </div>
                        </div>
                        <?php }
                        ...
                        <div class="col-sm">
                          ...
                          <div class="card-body fs2">
                            <a href="UnrecognizedOrg.php?file_id=<?php echo $res['ID'];?>&AFS=<?php echo $res['AFS'];?>"><button type="button" class="btn btn-info btn-sm mt-2"><i class=" fas fa-download" ></i></button></a>
                          </div>
                        </div>
                      </div>
                      <?php }
