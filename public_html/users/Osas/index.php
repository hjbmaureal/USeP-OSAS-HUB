          ...
          <div class="tile ">
            ...
            <div class="col-md-6">
              ...
              <div class="tile">
                ...
                <?php 
                         $sql = mysqli_query($conn,"SELECT * FROM viewresponse JOIN studentdetails ON viewresponse.student_id = studentdetails.student_id WHERE response_status = 'On Going' ORDER BY schedule_date, time_from ASC ");
