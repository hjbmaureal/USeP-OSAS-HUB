          ...
          <div class="tile ">
            ...
            <div class="col-md-6">
              ...
              <div class="tile">
                ...
                <?php 
                         $sql = mysqli_query($conn,"SELECT * FROM viewcomplaint WHERE Status = 'On Going' ORDER BY schedule_date ASC ");
                  
                            while($row = mysqli_fetch_array($sql)) {     
                              ?>

                <div class="fc-event">
                <p class="font-weight-bold" >COMPLAINANT: &emsp; <?php echo $row['fullname'].'<br>'.'DEFENDANT: &emsp;' .$row['Person_Complained'].'<br>'.'DATE: &emsp;' .$row['schedule_date'].'<br>'.'TIME: &emsp;' .$row['time_from'].'<br>'.' TYPE: &emsp;'.$row['meeting_type'].' <br>'.'MEETING LINK: &emsp;'.$row['meeting_link'].' <br>'.'MEETING ID: &emsp;'.$row['meeting_id'].' <br>'.'MEETING PASSCODE: &emsp;'.$row['passcode']; ?>
                  </div>
