                                ...
                                <div class="table-responsive">
                                  ...
                                  <table class="table table-hover table-bordered" id="sampleTable2">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            $tab = mysqli_query($conn, "SELECT s.student_id as Student_ID, s.first_name,s.middle_name,s.last_name,s.title, s.suffix, fullname(s.first_name,s.middle_name,s.last_name,s.title, s.suffix, '', 'firstname_first') as fullname, s.section as section, s.year_level, s.type, c.title as course_title, cl.title as college_title, cl.description as college_name, com.Complaint_ID as Complaint_ID, com.Date_Submitted as date_Submitted, com.Date_of_Incident as date_incident, com.Time_of_Incident as time_incident, com.Loc_of_Incident  as loc_incident, com.Person_Complained as person_complained, com.Designation_Complained as designation_complained, com.Detail as detail,  com.Witness1 as witness1, com.Witness2 as witness2, com.Witness3 as witness3, com.Status FROM student as s JOIN course as c ON c.course_id = s.course_id JOIN college as cl ON cl.college_id = c.college_id JOIN complaint as com ON com.Student_id = s.student_id WHERE com.Status = 'In Process' OR com.Status = 'Pending' OR com.Status = 'On Going'");
                                        ...
                                        <td class="text-center align-middle">
                                          ...
                                          data-witness3="<?php echo $res['witness3']; ?>"><i class="fas fa-eye"></i></button>
                                  ...
                                  <div class="row">
                                    <div class="col-sm">
                                      <div class="form-group fg mt-3">
                                        ...
                                        <br>
                                        <input class="form-control fc mt-4" type="text" placeholder="<?php echo $res['fullname']; ?>">
                                        <br>
