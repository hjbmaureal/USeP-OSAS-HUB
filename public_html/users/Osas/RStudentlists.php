...
<br>
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                  <div>
                    <div>
                        <div class="float-left"><h4>Student Labor Reports - Student Labor Lists</h4></div>
                    </div><br><br>
                      <div class="row">
                        <div class="col mt-1">
             ...
             <div class="inline-block float mr-7 mt-3">
                      <button class="btn btn-secondary" name="filter" type="submit" id="filter" style="margin-right: 12px; "><i class="fas fa-filter"></i>&nbsp; Filter</button>
                              ...
                              <div class="inline-block float mr-3 mt-3">
                                <button class="btn btn-success" name="submit_sll" type="submit" id="submit_sll" style="margin-right: 12px;" target="_blank"><i class="fas fa-print"></i>&nbsp; Print</button>
                              </div>
                        </div>        
                    </div>
                
                    <!-- FETCHING OF DATA & DIPLAY IT ON TABLE -->  
                    <div class="table-bd">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $("#monthDropdown").on('change', function(){
            ...
            $.ajax({
              url:"fetch_data_month.php",
              type:"POST",
              data: 'request=' + value,
              beforeSend: function(){
                $(".table-bd").html("<span>"Working on "</span>"); 
              },
    ...
    <!--Year Level Filter, this one guysue-->  
    <script type="text/javascript">
      $(document).ready(function(){
    ...
    <!--Semester Filter, this one guysue-->  
    <script type="text/javascript">
      $(document).ready(function(){
        $("#semDropdown").on('change', function(){
            var value = $(this).val();
            //alert(value);

            $.ajax({
              url:"fetch_data_Semester.php",
              type:"POST",
              data: 'request=' + value,
              beforeSend: function(){
                $(".table-bd").html("<span>"Working on "</span>"); 
    ...
    <!--print button!
    <script>
        $('.btn btn-danger btn-md verify').click(function(){
          var printme = document.getElementById('table table-hover table-bordered');
