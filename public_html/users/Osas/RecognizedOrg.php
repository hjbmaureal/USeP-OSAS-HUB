                                  ...
                                  <div class="item">
                                    ...
                                    <div class="row">
                                      ...
                                      <div style="padding-left: 2px;" class="col-sm">
                                        <button type="submit"  name="submit2" class="btn btn-danger btn-sm blocking float-left mt-2 w-50"  value="<?php echo $res['ID']?>"><i class="fas fa-thumbs-up" ></i></button>
                                      </div>
                                    </form>
                                    </div>
                                  </div>
...
if(isset($_POST['submit1']))
                                        {
                                          ...
                                          $id = $_POST['submit1'];
                                          $tab = mysqli_query($conn,"SELECT * from org_filess where ID like'$id'");
                                          $res = mysqli_fetch_array($tab);

                                          if($res){
                                            $quer = mysqli_query($conn,"SELECT * from approve_funded where id like '$id'");
...
if(isset($_POST['submit2']))
                                        {
                                          ...
                                          if($res){
                                            $tab1 = "DELETE * from org_filess where ID='$id'";
                                          $res1 = mysqli_query($conn,$tab1);
                                          $tab2 = "DELETE * from acree_files where org_id='$id'";
                                          $ress = mysqli_query($conn, $tab2);
