          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                  <div>
                    <div>
                        <div class="float-left"><h4>Student Labor Reports - Student Labor DTR</h4></div>
                    </div><br><br>
                      <div class="row">
                        <div class="col mt-1">
             ...
             <div class="inline-block float mr-7 mt-3">
                    ...
                    <form method="POST" action="PrintReports.php" target="_blank">
                              <div class="inline-block float mr-3 mt-3">
                                <button class="btn btn-success" name="submit_sldtr" type="submit" id="submit_sll" style="margin-right: 12px;" target="_blank"><i class="fas fa-print"></i>&nbsp; Print</button>
                              </div>                   
                   </div>
                      ...
                      $sql="SELECT * FROM sl_accomplishment_report where applicant_id is not null";
                       ...
                       if (!empty($_POST['yr_drpdwn']) || isset($_POST['month_drpdwn']) || isset($_POST['yr_lvl']) || isset($_POST['course_dropdwn']) || isset($_POST['college_drpdwn'])) {
                         # code...
