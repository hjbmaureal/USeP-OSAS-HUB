...
<h4 style="text-align: center;">JOB HIRINGS</h4> <br>
            ...
            while($row=mysqli_fetch_array($query)){
              echo'<div class="col-xl">
                       <div style="background-color: #C12C32; padding: 8px 10px;"> </div>
                        <div class="tile">
                            <h3 class="tile-title" >'.$row['title'].' - '.$row['office'].'</h3>
                            <div class="tile-body"><textarea class="form-control-plaintext px-5 shadow-none" id="content2" name="content2" rows="10" cols="100" style="text-align: justify; outline:none; min-height: 100px" readonly>'.$row['content'].'</textarea>
                            </div>
                        <div class="tile-footer text-right pr-4"><p><a class="btn btn-primary icon-btn" href="Home-Labor.php" >Apply Now</a></p></div>
                      </div>
                    </div>
              ';
            }
