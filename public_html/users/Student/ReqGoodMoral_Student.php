   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.js"></script>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu font-sec">
          ...
          <li><a class="app-menu__item active" href="ReqGoodMoral_Student.php"><i class="app-menu__icon fa fa-envelope-o"></i><span class="app-menu__label">Request for Good Moral</span></a></li>
  ...
  //CLOCK
      ...
      var loadFile = function (event,imgname) {
        ...
        <div class="red"> 
         ...
         <?php 
              $id = $_SESSION['id'];
              $sql = "SELECT  student.last_name,student.first_name,student.middle_name,student.Suffix,course.name,course.major,student.year_level
                        FROM student
                        JOIN course 
          ...
          <div class="tile">
            ...
            <div class="tile-body" >
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-4">
                    <p style="font-weight: bolder;">Year Level
                    <input class="form-control" type="text" id="year_level" name="year_level" value="<?php echo "$Ylevel"; ?>" disabled> </p>
                  </div>
                </div>
                ...
                <input class="form-control" type="from" id="from" name="from" placeholder="e.g 2012">
                </div>-
                <div class="form-group col-sm-3">
                <input class="form-control" type="to" id="to" name="to" placeholder="e.g 2013">
                </div>
                </div>
