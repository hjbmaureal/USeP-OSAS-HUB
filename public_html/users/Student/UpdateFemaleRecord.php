 ...
 ?>
  ...
  <html lang="en">
    <head>
      ...
      <title>Consultation: Patient Record Male Form</title>
      <meta charset="utf-8">
            ...
            <div class="tile-body">
                                  <form  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="whenn" id="whenn" value="" >
                                      </div>
                                     <div class="form-group col-md-4">
                                      ...
                                      <div class="form-group col-md-4">
                                       ...
                                       <div class="form-group col-md-4">
                                        <label for="inputEmail4"><b>When?</b></label>
                                        <input type="text" class="form-control" name="whennn" id="whennn" value="">
                                      </div>
                                   </div>
                                     <br>   
                                   ...
                                   <div class="form-row">
                                      <div class="form-group col-md-4">
                                        <label class=" control-label"><b>At what age did you have your first menstruation?</b></label>
                                         <input type="text" class="form-control" name="first" required="required" placeholder="ex. 12 years old">
                                      </div>
                                </div>
                               ...
                               <div class="form-row">
                                      ...
                                      <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="peryear" id="peryear" placeholder="ex. 2/year">
                                      </div>
                                </div>
  ...
  $db=$db; // Enter your Connection variable;
  $tableName='clinic_patient_info'; // Enter your table Name;
  ...
  if(isset($_POST['female'])){   
    ...
    $l = "DELETE FROM clinic_patient_info WHERE patient_id='$patient_id'";
    ...
    if(empty($patient_id)||empty($hospitalized)|| empty($operation)|| empty($disease)|| empty($illness) || empty($permission) ||empty($first)|| empty($regular) || empty($dysmenorrhea)) { 
      ...
      $ll = "DELETE FROM clinic_patient_info_female WHERE patient_id='$patient_id'";
     if(mysqli_query($db, $ll)){

    // checker
    if(empty($patient_id)||empty($first)|| empty($regular) || empty($dysmenorrhea)) { 
    ...
    $resu = $db->query($s);
      ...
      foreach($checkbox1 as $chk1)  
       ...
       foreach ($_FILES['file_name']['name'] as $key => $name){
                  ...
                  $newFilename = $name;
                  move_uploaded_file($_FILES['file_name']['tmp_name'][$key], 'filesuploaded/' . $newFilename);
                  $location = 'filesuploaded/' . $newFilename;
              } 


    $in_ch=mysqli_query($db,"INSERT INTO clinic_patient_info(patient_id,admitted,admitted_illness,admitted_illness_start,operation,operation_kind,operation_when,infectious_disease,headaches,swear_clause,lab_tests) VALUES('$patient_id','$hospitalized','$ill','$whenn','$operation','$kind','$whennn','$chk','$illness','$permission','$location')"); 
    ...
    if($in_ch==1)  
       {  
           ...
           $result5 = $db->query($sql);
            ...
            echo '<script>
            swal({
            title: "Your Record was Updated Successfully!",
  ...
  $in_chh=mysqli_query($db,"INSERT INTO clinic_patient_info_female(patient_id,mens_age_start, mens_regular,mens_irregular,dysmenorrhea,pms) VALUES('$patient_id','$first','$regular','$peryear','$dysmenorrhea','$premen')"); 
