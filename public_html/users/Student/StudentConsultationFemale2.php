       ...
       <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
                                  <form action="addinfofemale.php" method="post">
                                    <br>
                                    <div class="form-row">
                               ...
                               <div class="form-row">
                                      <div class="form-group col-md-4">
                                        <label for="inputEmail4"><b>Do you have regular monthly periods?</b></label>
                                         <div class="">
                                            <select class="form-control" name="regular" id="regular" onChange="changetextbox2()">                                  
                                                <option value="No">No</option>
                                                <option value="Yes">Yes</option>
                                            </select>
                                        </div>
                         ...
                         <br><br><br><br>
                            ...
                            <div class="tile-footer">
                              <button class="btn btn-primary" name="Submit" href="Clinic-Complaints.php" ><i class="fa fa-fw fa-lg fa-check-circle"></i>Submit</button> 
                            </div>
...
{
   onChange="changetextbox2();"
if (document.getElementById("regular").value == "Yes") {
document.getElementById("peryear").disabled=true;
    } else {
        document.getElementById("peryear").disable='false';
    }
}
</script>
<script type="text/javascript">
