  ...
  <html lang="en">
   ...
   <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><i class=" fas fa-bell fa-lg mt-2"></i></a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h4 class="tile-title">SETTING UP CONSULTATION</h4>
            <div class="tile-body">
                                    ...
                                    <div class="form-row">
                                     ...
                                     &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                        ...
                                        <div class=""> 
                                          <b>Preferred Mode of Communication (First Option)</b>
                                      ...
                                      <div class=""> 
                                          <b>Preferred Mode of Communication (Second Option)</b>
                                            <select  name="modei" id="modei"  class="form-control" style="height: 35px;width: 250px" data-table="reports-list">
                                ...
                                <div class="form-row">
                                      <div class="form-group col-md-12">
                                        <label class="control-label"><b>What seems to be the problem?</b></label>
                                          <textarea name="problem" class="form-control rounded-10" rows="6" required="required" placeholder="Type your complaints here; you may use Bisaya, Tagalog, or English..."></textarea>
                                      </div>
