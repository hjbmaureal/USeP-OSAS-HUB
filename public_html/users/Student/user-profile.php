      ...
      <div class="main-content-student">
        <form action="../../php/updateProfile.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="float-left">
            <h2>USER PROFILE</h2>
            <input type="text" value="<?php echo $id?>" name="student_id">
          </div>
              ...
              <div class="tile">
                <div class="row">
                  ...
                  <div class="col-6">
                    ...
                    <div class="tile-body">
                      <div style="height: 150px; width: 150px;border-radius: 50%;margin-left: 20px;">
                         <img class="rectangle" src="data:image/jpeg;base64,<?php echo $_SESSION['user_signature'] ?>" style="max-width:100%;" />
                      </div>
