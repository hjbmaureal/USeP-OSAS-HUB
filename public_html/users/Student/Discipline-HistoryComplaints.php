        ...
        <ul class="app-menu font-sec">
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-comments"></i><span class="app-menu__label">Student Discipline Services</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a class="treeview-item active" href="Discipline-HistoryComplaints.php">Complaint Records</a></li>
      ...
      var loadFile = function (event,imgname) {
       ...
       <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div class="float-left"><h4>Pending Complaint Schedule</h4></div>
                  </div>
                  <br><br>
      ...
      <div class="table-bd">
                <div class="table-responsive">
                  ...
                  <tbody>
                    <tr>
 <?php
                  $tab = mysqli_query($conn,"SELECT * FROM viewcomplaint JOIN studentdetails ON viewcomplaint.student_id = studentdetails.student_id WHERE viewcomplaint.student_id = '$id' AND (viewcomplaint.Status = 'Pending' OR viewcomplaint.Status = 'In Process')");
                  ...
                  while($res = mysqli_fetch_array($tab)) {         
                      ?>
                                 <td><?php echo $res['Complaint_ID']; ?></td>
                    ...
                    <?php 
                      ...
                      <td>
                        <button class="btn btn-info btn-sm" data-toggle="modal" a href="#exampleModal<?php echo $res['Complaint_ID']; ?>"><i class="fas fa-eye"></i></button>
                        <?php include('modal/ComplaintForm_modal.php');?>
                      </td>
                      </tr>
                              <?php 
                                }
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div class="float-left"><h4>Complaint Records</h4></div>
                  </div>
                  <br><br>
                  <div class="table-bd">
                <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <?php
                  $tab = mysqli_query($conn,"SELECT * FROM viewcomplaint JOIN studentdetails ON viewcomplaint.student_id = studentdetails.student_id WHERE viewcomplaint.student_id = '$id' AND (viewcomplaint.Status = 'Done' OR viewcomplaint.Status = 'Closed')");
                    $row=mysqli_num_rows($tab);
