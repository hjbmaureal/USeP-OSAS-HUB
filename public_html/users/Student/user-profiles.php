                ...
                <div class="container">
                  <div class="row">
                   ...
                   <?php    
                    ...
                    $result = mysqli_query($conn, "SELECT * FROM studentdetails where Student_id='$id'");
                     $row = mysqli_fetch_assoc($result);echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['pic'] ).'" class="prof" id="userPic"/>';?>
                      </div>
                      <div class="image-upload">
                        <label for="file-input"> <img class="camera" src="../../images/camera1.png" style="cursor: pointer;"> </label>
                        <input type="file" id="file-input" name="profilePic" onchange="loadFile(event, 'userPic')" style="display: none;">
                    </div>
                  </div>
                    <div class="col-lg">
