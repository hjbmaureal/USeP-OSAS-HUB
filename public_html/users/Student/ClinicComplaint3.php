  ...
  <html lang="en">
   ...
   <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><i class=" fas fa-bell fa-lg mt-2"></i></a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h4 class="tile-title">CONSULTATION</h4>
            <div class="tile-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="">
                                          <b>Consultation type</b>
                                            <select  name="type" id="type" class="form-control" style="height: 35px;width: 250px" data-table="reports-list">
                                     ...
                                     &ensp;&ensp;&ensp;&ensp;
                                        ...
                                        <div class=""> 
                                          <b>Mode of Communication</b>
                                            <select  name="mode" id="mode"  class="form-control" style="height: 35px;width: 250px" data-table="reports-list">
                                      ...
                                      &ensp;&ensp;&ensp;&ensp;
                                        ...
                                        <div class=""> 
                                          <b>Semester</b>
                                            <select  name="semester" id="semester"  class="form-control" style="height: 35px;width: 250px" data-table="reports-list">
                                      ...
                                      <div class=""> 
                                          <b>School Year</b>
                                            <select  name="schoolyear" id="schoolyear"  class="form-control" style="height: 35px;width: 250px" data-table="reports-list">
                                ...
                                <div class="form-row">
                                      <div class="form-group col-md-12">
                                        <label class="control-label"><b>What seems to be the problem?</b></label>
                                          <textarea name="problem" class="form-control rounded-10" rows="6" required="required" placeholder="Type your complaints here..."></textarea>
                                      </div>
    ...
    // checker
     if(empty($patient_id)||empty($type)||empty($mode)||empty($problem)) { 
       ...
       echo "<br/><a href='javascript:self.history.back();'>Go Back</a>";
        ...
        //insert syntax
        $result ="INSERT INTO consultation(patient_id,type,communication_mode,patient_type,problems,date_filed, status,semester, school_year) VALUES('$patient_id','$type','$mode','$patient_type','$problem',now(),'$status','$semester', '$school_year')";
