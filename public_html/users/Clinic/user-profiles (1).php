...

{
  ...
  $sql = mysqli_query($mysqli, "SELECT * from consultation_details where patient_id='$patientid'");
                         ...
                         <div class="row">
                               <div class="col-4">
                                    ...
                                    <div style="height: 200px; width: 150px;border-radius: 50%;margin-left: 40px;"><img src="image/female_user.png" style=" vertical-align: middle; max-width: 100%; border-radius: 50%;">
                                      ...
                                      <h5 style="margin-left: 40px; margin-top: 10px;"><?php echo $name ?></h5> 
                                ...
                                <div class="col-lg">
                                      ...
                                      <h5>Patient Name:&nbsp;<span class="font-weight-lighter ml-2"><?php echo $name ?></span></h5>
                ...
                <div class="float-left"><h4>Patient History</h4></div>
                  ...
                  <div class="row">
                    <div class="col-auto">
                      ...
                      <div class="col"><button class="btn btn-danger btn-sm verify"  onClick="Export()" style="margin-left: 90%;"><i class="fas fa-download" data-toggle="modal" data-target="#RequestModal"></i> Export </button></div>
                  </div>
                </div>
                    ...
                    <div class="modal-content" id="content">
                      <div class="modal-header">
                       ...
                       <div class="col-sm-12">
                        ...
                        <h6  class="font-weight-bold">Year level: <span class="font-weight-lighter ml-2"></span></h6>
                          <br>
                          <br>
                        </div>
                      </div>
