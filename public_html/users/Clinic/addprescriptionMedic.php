                        ...
                        <br><br>
                               ...
                               <div class=""> 
                                          ...
                                          <b>Select Medication:</b>
                                            <select  name="art_fotoselects" id="art_fotoselects" class="form-control" style="height: 35px;width: 250px" data-table="reports-list">
                                      ...
                                      <h6 class="font-weight-bold">Quantity: </h6>  
                                          <input  type="number" name="quan2" id="quan2" class="form-control" ></input>
                                           <div>
                                            <button type="button" name="added" id="added" class="btn btn-success">Add</button></div>
                                      ...
                                      <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" name="art_testo" id="i252x" rows="4" placeholder="If no prescription provided just put N/A..."></textarea>
...
Art_AddFotor = (e) => {
var b = "Quantity = ";
document.querySelector('#i252x').value += document.querySelector('#art_fotoselects').value+"\r\n";
document.querySelector('#i252x').value += b+document.querySelector('#quan2').value+"\r\n";
}
