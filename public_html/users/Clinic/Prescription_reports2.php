         ...
         <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-comment-medical"></i><span class="app-menu__label">Request</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-comment-medical"></i><span class="app-menu__label">Reports</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a class="treeview-item active" href="Prescription_reports.php">Prescription Reports</a></li>
		...
		<thead>
			...
			<th><h4><center> Prescription Reports</center></h4></th>
			 ...
			 <table class="table table-hover table-bordered reports-list" id="myTable">
                  ...
                  <tbody> 
				  <?php
				  $sql = "SELECT consultation.consultation_type,consultation.communication_mode,consultation.patient_id, consultation.prescription_date_issued,consultation.prescription_details,CONCAT(student.first_name,' ',student.middle_name,' ', student.last_name) as name, course.title from consultation join student on consultation.patient_id=student.Student_id join course on student.course_id=course.course_id where consultation.prescription_details!='NULL' order by prescription_date_issued ASC";
