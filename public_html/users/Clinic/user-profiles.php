  ...
  <html lang="en">
    <head>
     ...
     <link rel="stylesheet" type="text/css" href="css/main.css">
      ...
      <link rel="stylesheet" type="text/css" href="cssc/announcements.css">
      <link rel="stylesheet" type="text/css" href="cssc/upstyle.css">
      <link rel="stylesheet" type="text/css" href="cssc/upstyle_main.css">
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-lg">
                      ...
                      $id = $_SESSION['id'];  
                      $result = mysqli_query($db,"SELECT * FROM staffdetails WHERE staff_id = '$id'");
