...
function timeago($datetime, $full = false) {
 ...
 if(isset($_POST['AddItem'])){
  ...
  $nm = $_POST['item_nm'];
    ...
    $sql2 = "INSERT INTO item_list VALUES (NULL, '$cd', '$un', '$nm', NOW())";
  ...
  $result5=mysqli_query($db,"UPDATE item_list SET item_code='$itemid', unit='$itemun', item_name='$itemnm' WHERE id='$itemno'");
         ...
         <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon  fas fa-file-medical"></i><span class="app-menu__label">Request</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-clipboard-list"></i><span class="app-menu__label">Item</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              ...
              <li><a class="treeview-item active" href="Admin-ItemList.php">Item List</a></li>
      ...
      <!-- Navbar-->
         ...
         <!--<div class="page-error tile">-->
          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                <div>
                <div>
                <h4 class="mb-3 line-head">Item List</h4>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-auto">
                    ...
                    <div class="inline-block">
                      <b>Unit</b><br>
                    <select class="bootstrap-select" name="filterunit5" id="filterunit5" style="width: 150px;">
                      ...
                      <div class="col">
                        <br>
                          <div class="inline-block float ml-2 mt-1"><button class="btn btn-success btn-sm verify" data-toggle="modal" data-target="#AddNewType" style="width: 100%;"><i class="fas fa-plus" data-toggle="modal" data-target="#AddNewType"></i> New Item </button></div>
                      </div>
                ...
                <div class="table-responsive">
                  ...
                  <div class="calldiv5" id="calldiv5">
                   <table class="table table-hover table-bordered reports-list" id="sampleTable5">
                    <thead>
                      <tr>
          ...
          <?php 
                ...
                $sql = "SELECT item_list.*, item_unit.unit as unit_name FROM item_list JOIN item_unit ON item_unit.unit_id=item_list.unit";
                $cnt=1;
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body c">
                        <div class="container">
                          <?php
                            $sql1="SELECT unit_id, unit FROM item_unit";
                          ?>
                          <form method="post" action="">  
                            ...
                            <div class="col-sm">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" placeholder="Enter item code" name="item_cd">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="form-group">
                                    <label for="exampleSelect1">Unit</label>
                                    <select class="form-control" id="exampleSelect1" name="unitnm">
                          ...
                          <div class="row">
                            <div class="col-sm">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" placeholder="Enter new equipment or supply" name="item_nm">
                                </div>
                            </div>
                          </div>
   ...
   <script src="js/jquery-3.3.1.min.js"></script>
    ...
    $(this).closest('table').find('td input:checkbox').prop('checked', this.checked);
      ...
      $(document).ready(function(){
                  /*STATUS*/
                  $("#filterunit5").on('change', function(){
                    var filterunit5 = $("#filterunit5").val();

                    $.ajax({
                          url:"filterInventory.php",
                          type:"POST",
                          data:{funit5 : filterunit5},
                          beforeSend:function(){
                            $(".calldiv5").html("Working.....");
                          },
