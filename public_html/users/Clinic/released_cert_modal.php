                    ...
                    <div class="modal-content">
                      ...
                      <form method="POST" action="generate_cert.php">
                       ...
                       <h6 class="font-weight-bold">Name of Consultant: <input type="text" name="consultant"  style="border-top:none;border-left: none;border-right: none;outline: none;background-color: #F5F5F5;"></input></h6> 
                        ...
                        <h6 class="font-weight-bold">Found him/her to be with: <input type="text" name="found"  style="border-top:none;border-left: none;border-right: none;outline: none;background-color: #F5F5F5;"></input></h6> 
                        <br>
