    ...
    <head>
      ...
      <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
        ...
        <ul class="app-menu font-sec">
          ...
          <li><a class="app-menu__item" href="index.php"><i class="app-menu__icon fa fa-chart-bar"></i><span class="app-menu__label">Dashboard</span></a></li>
         ...
         <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-comment-medical"></i><span class="app-menu__label">Request</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <li class="treeview"><a class="app-menu__item active" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-comment-medical"></i><span class="app-menu__label">Reports</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
              <li><a class="treeview-item" href="Consultation_Reports.php">Consultation Reports</a></li>
                    ...
                    <select class="bootstrap-select" data-table="reports-list">
                        <option class="select-item" value="1" selected="selected">All</option>
                         ...
                         <?php
                                                  ...
                                                  $sql=mysqli_query($conn,"select * from course where status='Active'");
                  ...
                  <div class="inline-block">
                    ...
                    <select class="bootstrap-select" data-table="reports-list">
                        <option class="select-item" value="1" selected="selected">All</option>
                         <?php
                                                  // Feching active mode of communication
                                                  $sql=mysqli_query($conn,"select * from semester where status='Active'");
                                                  while($result=mysqli_fetch_array($sql))
                                                  {    
                                                  ?>
                    ...
                    <select class="bootstrap-select" data-table="reports-list">
                        ...
                        <?php
                                                  // Feching active mode of communication
                                                  $sql=mysqli_query($conn,"select * from school_year where status='Active'");
                                                  while($result=mysqli_fetch_array($sql))
                                                  {    
                                                  ?>
            ...
            <div id="table_clone" style="display: compact">
              <table  class="head">
                <thead>
                  ...
                  <tr>
                  <th><img src="../../images/logo.png" width="100"></th>
                  <th width="100"></th>
                  ...
                  <tbody>				   <?php 
                      ...
                      $stat = "Completed";
                        ...
                        $sql = "SELECT consultation.id,consultation.patient_id,CONCAT(student.first_name,' ',student.last_name) as fullname,course.title,consultation.consultation_type,consultation.communication_mode, consultation.appointment_date, consultation.semester, consultation.school_year from consultation inner join student  on consultation.patient_id=student.Student_id inner join course on student.course_id=course.course_id WHERE consultation.status='$stat'  order by appointment_date";
