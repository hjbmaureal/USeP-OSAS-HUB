                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body c">
                        ...
                        <div class="container" style="border: 1px solid black; margin-top: 10px; padding: 20px; border-radius: 10px;">
                              ...
                              <a href="patient-profiles.php?patient_id=<?php echo $row["patient_id"]; ?>" target="_blank"><button class="btn btn-danger btn-sm" style="width: 100%; margin-top: 5px; font-size: 10px;"><i class="fas fa-exclamation-triangle"></i> View Medical Info/History
                              </button></a></div>
                         ...
                         <h6 class="font-weight-bold">Tooth: </h6> 
                            <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" required="required" name="tooth" id="tooth" rows="3" placeholder="Type here..."></textarea>
                                      </div>
                          </div>
                          <h6 class="font-weight-bold">Surface: </h6> 
                            <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" required="required" name="surface" id="surface" rows="3" placeholder="Type here..."></textarea>
                                      </div>
                          </div>
                           ...
                           <h6 class="font-weight-bold">Diagnosis: </h6> 
                            <div class="form-row">
                                      <div class="form-group col-md-12">
                                          <textarea class="form-control rounded-10" required="required" name="diagnosis" rows="3" placeholder="Type diagnosis here..."></textarea>
                                      </div>
                          </div>
  ...
  if(isset($_POST['Submit'])){   
    ...
    if(empty($tooth)||empty($surface)||empty($diagnosis)|| empty($treatment)|| empty($remarks)) { 
        ...
        $result ="UPDATE consultation 
                  SET tooth='$tooth', surface='$surface', diagnosis='$diagnosis',status='$status', treatment='$treatment', remarks='$remarks',date_completed=now()
                  WHERE id ='$id'";
