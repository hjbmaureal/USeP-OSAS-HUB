         ...
         <div class="row">
            ...
            <div class="tile-body"style="text-align: center; font-weight: bold;" >STEP 4
              ...
              *Oath of Office
              ...
              <br>
            <button class="btn btn-primary icon-btn center" data-toggle="modal" data-target="#exampleModalLong" style="padding-left: 135px; padding-right: 135px;"> Read More</button>       
            </div>
            </div>
