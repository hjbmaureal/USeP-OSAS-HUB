...
<body>
                                    ...
                                    if(course_value){
                                       $.ajax({
                                        ...
                                        success:function(response)
                                        {
                                            ...
                                            var str = "";
                                            for (var i = 0; i < obj.length; i++) {
                                                var curval = (obj[i].major.length > 1) ? obj[i].major : '';
                                                $('#major').append("<option value='"+obj[i].course_id+"'>"+curval+"</option>");
                                            }
                                        },
                                        error: function(response){
                                          alert("fail" + JSON.stringify(response));
    ...
    <div class="row row-space">
        <div class="col-2">
            <div class="input-group">
                ...
                <input class="input--style-4" style="width:550px" name="sdfLivingWithSpecifyUpdate" type="text" id="sdfLivingWithSpecifyUpdate" required>
            </div>
        </div>
    </div>
    ...
    <div class="row row-space">
        <div class="col-2">
            <div class="input-group">
                ...
                <input class="input--style-4" input name="sdfContactNumberUpdate" type="text" id="sdfContactNumberUpdate" required>
            </div>
        </div>
        <div class="col-2">
            <div class="input-group">
                <label class="label2" for="sdfCityAddressUpdate">City Address <i>*</i></label>
                <input class="input--style-4" name="sdfCityAddressUpdate" type="text" id="sdfCityAddressUpdate" required >
            </div>
        </div>
    </div>
    ...
    <div class="row row-space">
        <div class="col-2">
            <div class="input-group">
                ...
                <input class="input--style-4"  name="sdfParentNameUpdate" type="text"  id="sdfParentNameUpdate" required>
            </div>
        </div>
        <div class="col-2">
        </div>
    ...
    <div class="row row-space">
        <div class="col-2">
            <div class="input-group">
                ...
                <input class="input--style-4" name="sdfParentOccupationUpdate" type="text" id="sdfOccupationUpdate" required>
            </div>
        </div>
        <div class="col-2">
            <div class="input-group">
                <label class="label2" for="sdfParentContactNumberUpdate">Contact Number <i>*</i></label>
                <input class="input--style-4 contact" name="sdfParentContactNumberUpdate" type="text"  id="sdfParentContactNumberUpdate"  maxlength="11" required>
            </div>
        </div>
    </div>
    ...
    <div class="row row-space">
        <div class="col-2">
            <div class="input-group">
                ...
                <input class="input--style-4" style="width:550px" name="sdfParentAddressUpdate" type="text" class="form-control" id="sdfParentAddressUpdate" required>
            </div>
        </div>
    </div>
    ...
    <div class="input-group">
     <div class="input-group">
        <label class="label" style="font-size: 13px;">CURRENT CERTIFICATE OF REGISTRATION  <i>(upload pdf file only) *</i></label>
        <input class="trans-input" type="file" id="myFile" name="cor"  required>
    </div>
    <div class="input-group">
        <label class="label">ID PICTURE  <i>*</i></label>
        <input class="trans-input" type="file" id="myPic" name="id_pic" required>
    </div>
</div>
<hr>
...
<div class="d-flex mb-5 align-items-center">
    <label class="control control--checkbox mb-0"><span class="caption"><a data-toggle="modal" data-target="#myModal" style="text-decoration: underline;">Click here to read our Data Privacy Statement before creating your account.</a></span>
      <input type="checkbox" disabled required="" id="clickhere">
          ...
          <div class="container">
            <div class="row">
                <div class="form-group col-sm">
                    <p style="color: black;">Dear Student,</p><br>
                    <p style="color: black;">Welcome to the (Academic Year 2021-2022)!</p><br>      
...
<script>
   ...
   $('#myPic').change(function(){
        var fi = document.getElementById('myPic');
        var fsize = 0;
        ...
        if (Math.round((fsize / 1024)) > 1000) {
            alert('Picture must be below 500 kb only');
            $(this).val('');
        }
    }); 
    ...
    function isChecked(){
        ...
        if(document.getElementById('sdfLivingWithParentsUpdate').checked){
          ...
          document.getElementById('sdfCityAddressUpdate').disabled = false;
          document.getElementById('sdfParentAddressUpdate').disabled = true;
          document.getElementById('sdfParentContactNumber').disabled = false;
...
$(document).ready(function($){  
        ...
        $(document).on("focusout","#id_num",function(){
        ...
        $('#studentregfrm').submit(function(e){
            ...
            if (validatesid > 0) {
                swal("Invalid!", "You have already filled out the registration form. An email will be sent to you verifying your registration. If you've already received an email, please proceed to the login page.", "warning");
                e.preventDefault();
                return false;
            } 
            if ($('#major').length > 1 && $('#major').val().length == 0) {
                e.preventDefault();
                $('#major').focus();
                return false;
            }
            if(!$('#clickhere').is(":checked")){
                e.preventDefault();
                swal("Wait!", "Please read the Data Privacy Act first!", "warning");
            }
        });
