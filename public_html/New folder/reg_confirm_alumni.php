...
if(isset($_POST['submit'])) {    
    ...
    $fileinfo2=PATHINFO($_FILES["prof_pic"]["name"]);
    ...
    if($ext != "png" && $ext != "jpeg" && $ext != "jpg" && $ext != "PNG" && $ext != "JPEG" && $ext != "JPG"){
        $msg = "?status=err";
        header("Location: register_alumni.php".$msg);
        exit();
    }
    if($ext2 != "png" && $ext != "jpeg" && $ext != "jpg" && $ext != "PNG" && $ext != "JPEG" && $ext != "JPG"){
        $msg = "?status=err";
        header("Location: register_alumni.php".$msg);
        exit();
    }
        ...
        move_uploaded_file($_FILES["id_pic"]["tmp_name"],"docs/alumni_id_pic/" . $newFilename);
        move_uploaded_file($_FILES["prof_pic"]["tmp_name"],"docs/alumni_profile_pic/".$newFilename2);
        $location="alumni_id_pic/" . $newFilename;
        $location2="alumni_profile_pic/".$newFilename2;
    }


    
    $course_sql = "SELECT course_id FROM course WHERE name = '".$course."'";
    /*$course_sql = "SELECT course_id FROM course WHERE major = '".$major."' and name = '".$course."'";*/
